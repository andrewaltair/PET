 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.get('/', auth_1.authenticateToken, conversationController_1.ConversationController.getUserConversations);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.post('/provider/:userId', auth_1.authenticateToken, conversationController_1.ConversationController.createConversationWithProvider);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.get('/:conversationId/messages', auth_1.authenticateToken, conversationController_1.ConversationController.getConversationMessages);
/**
 * @swagger
 * /conversations/{conversationId}/messages:
 *   post:
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.post('/:conversationId/messages', auth_1.authenticateToken, conversationController_1.ConversationController.sendMessage);
