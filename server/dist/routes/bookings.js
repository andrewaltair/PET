 ...
 */
router.post('/service/:serviceId', auth_1.authenticateToken, auth_1.requireOwnerRole, (0, validation_1.validateRequest)(petservice_marketplace_shared_types_1.createBookingSchema), bookingController_1.BookingController.createBooking);
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.get('/my-as-owner', auth_1.authenticateToken, auth_1.requireOwnerRole, (req, res) => {
    try {
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.get('/my-as-provider', auth_1.authenticateToken, auth_1.requireProviderRole, (req, res) => {
    try {
        // Return mock data for testing
        const response = {
            success: true,
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.put('/:bookingId/status', auth_1.authenticateToken, (0, validation_1.validateRequest)(petservice_marketplace_shared_types_1.updateBookingStatusSchema), bookingController_1.BookingController.updateBookingStatus);
