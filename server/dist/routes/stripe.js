 ...
 */
router.post('/connect/onboard', auth_1.authenticateToken, auth_1.requireProviderRole, stripeController_1.StripeController.createOnboarding);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.get('/connect/account-status', auth_1.authenticateToken, auth_1.requireProviderRole, stripeController_1.StripeController.getAccountStatus);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.post('/bookings/:bookingId/create-payment-intent', auth_1.authenticateToken, auth_1.requireOwnerRole, stripeController_1.StripeController.createPaymentIntent);
/**
 * @swagger
 * /stripe/webhook:
 *   post:
