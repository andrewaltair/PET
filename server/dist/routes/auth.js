 ...
 */
router.post('/register', (0, validation_1.validateRequest)(petservice_marketplace_shared_types_1.createUserSchema), authController_1.AuthController.register);
/**
 * @swagger
 * /auth/login:
 *   post:
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.post('/login', (0, validation_1.validateRequest)(petservice_marketplace_shared_types_1.loginSchema), authController_1.AuthController.login);
/**
 * @swagger
 * /auth/me:
 *   get:
