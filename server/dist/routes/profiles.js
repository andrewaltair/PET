 ...
 */
router.get('/me', auth_1.authenticateToken, profileController_1.ProfileController.getMyProfile);
/**
 * @swagger
 * /profiles/me:
 *   put:
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.put('/me', auth_1.authenticateToken, (0, validation_1.validateRequest)(petservice_marketplace_shared_types_1.updateProfileSchema), profileController_1.ProfileController.updateMyProfile);
/**
 * @swagger
 * /profiles/me:
 *   post:
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.post('/me', auth_1.authenticateToken, (0, validation_1.validateRequest)(petservice_marketplace_shared_types_1.updateProfileSchema), profileController_1.ProfileController.createMyProfile);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ApiResponse'
 */
router.get('/provider/:userId', profileController_1.ProfileController.getProviderProfile);
