...
import { CreateServiceRequest, UpdateServiceRequest, ApiResponse, Service, ServiceWithProvider, PaginatedServicesResponse } from 'petservice-marketplace-shared-types';
...
export class ServiceController {
  ...
  static async getServices(req: Request, res: Response): Promise<void> {
    try {
      ...
      const result = await ServiceService.getPublicServices(page, limit, search, serviceType);
